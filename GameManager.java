 ...
 * 
 * This class contains methods for the core workings of the project. 
 * These are primarily helper methods for formatting output and validating input.
 * 
 * Students should not need to change or add to this class, but are of course welcome to!
 */
